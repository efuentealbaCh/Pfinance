...
- Posibilidad de asociar transacciones a una meta

### [ ] 3. Exportar datos (CSV / PDF)
- Backend: endpoint `GET /transactions/export?format=csv&from=&to=`
- Usar `league/csv` o respuesta `StreamedResponse` de Laravel
...
### [ ] 4. Filtros avanzados en Transacciones
...
### [ ] 5. Gráficos de tendencias históricas
